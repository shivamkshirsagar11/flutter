...
void main() {
  ...
  print(fullName('Shivam', 'Kshirsagar'));
  print(fullName('Darshan', 'Pandya', 'Expert'));

  print(dvwithinTolerance(6));
  print(dvwithinTolerance(78));
  print(dvwithinTolerance(45, 7, 781));
  print(dvwithinTolerance(6, 7));

  print(npwithinTolerance(91, min: 4, max: 456));
  print(npwithinTolerance(0, max: 123, min: 789));
  print(npwithinTolerance(78));
  print(npwithinTolerance(78));
  print(npwithinTolerance(78, min: 70));
  print(npwithinTolerance(56, max: 200));

  print(mnprwithinTolerance(value: 79));
  ...
  print(youAreWonderful('Shivam'));

  print(youAreWonderful2('Shivam', 10));

  print(youAreWonderful3(name: 'Antra'));

  print(wonderful4('Shivam'));
