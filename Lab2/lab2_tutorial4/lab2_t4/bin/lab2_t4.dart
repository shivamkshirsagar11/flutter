...
void main() {
  ...
  print('Equal.. \'dog\'==\'cat\': $guessEqualsCat');
  ...
  */
  ...
  /// another `String` constant named `Shivam` and set it to `'Shivam Kshirsagar'`.
  /// Create a Boolean constant named `ShivamIsReader` that uses string equality
  /// to determine if `reader` and `Shivam` are equal.
  const reader = 'Shivam Kshirsagar';
  const jay = 'Jay Kshirsagar';
  const jayIsReader = reader == jay;
  print('jayIsReader: $jayIsReader');
