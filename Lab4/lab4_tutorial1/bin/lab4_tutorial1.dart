...
void main() {
  ...
  //Challenge 1:
  final ernie = Student('Shivam', 'Kshirsagar', 95);
  final bert = Student('Antra', 'Agarawal', 85);
  print('$ernie\n$bert');
...
///in constructor.
void constructors() {
  // final user = User(42, 'Shivam');
  // final user = User(id: 42, name: 'Shivam');
  // final user = User(_id: 42, _name: 'Shivam');
  ...
  print(jb);
  const user = User(id: 42, name: 'Shivam');
  print(user);
...
void dartObjects() {
  ...
  const Shivam = User(id: 42, name: 'Shivam');
  print(Shivam.id);
  print(Shivam.name);
  // final email = Email();
  // email.value = 'Shivam@example.com';
  final email = Email('shivam@example.com');
...
void staticMembers() {
  ...
  // final user = User.fromJson('{"id":42,"name":"Shivam"}');
  final map = {'id': 10, 'name': 'Manda'};
  final manda = User.fromJson(map);
  print(manda);
}
